...
class UsuarioController{
    ...
    public function cadastrar(){
        ...
        $usuario->salvar();
        header('Location: /PBE_PHP_2026/MVC_MySql/usuario/telaCadastro');
        exit;
    }
    ...
    public function atualizar(){
        ...
        header('Location: /PHP_PBE_2026/MVC_MySql/usuario/telaEditar?id='.($_GET['id']));
        exit;
    }

    public function excluir(){
        Usuario::excluir($_GET['id']);
        header('Location: /PBE_PHP_2026/MVC_MySql/usuario/listar');
        exit;
    }
}
